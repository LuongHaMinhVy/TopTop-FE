  ...
  return (
    <div className={`flex flex-col gap-3 ${className}`}>
      ...
      >
        ...
        <span className="flex-1 text-center font-bold text-[15px] text-[#3c4043]">{t("continueWithGoogle")}</span>
      </button>
      ...
      >
        ...
        <span className="flex-1 text-center font-bold text-[15px]">{t("continueWithFacebook")}</span>
      </button>
    </div>
  );
};
