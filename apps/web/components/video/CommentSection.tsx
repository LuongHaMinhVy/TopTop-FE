        ...
        <div className="p-4 border-t border-elevated/30 bg-background/80 backdrop-blur-md">
          {currentUser ? (
            <div className="space-y-2">
              ...
              {activeImageDraft && (
                <div className="relative w-fit max-w-[220px] overflow-hidden rounded-xl border border-elevated bg-elevated">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src={activeImageDraft.previewUrl}
                    alt="Ảnh bình luận"
                    className="block max-h-56 max-w-[220px] object-contain"
                  />
                  <button
                    type="button"
                    onClick={() => {
            ...
            {!comment.deleted &&
              ...
              comment.mediaType === "IMAGE" && (
                ...
                <img
                  ...
                  className="mt-2 block max-h-56 max-w-[220px] rounded-xl object-contain"
                />
              )}
          </div>
