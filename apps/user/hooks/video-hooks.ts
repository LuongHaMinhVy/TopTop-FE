...
const updateVideoInCache = (queryClient: QueryClient, videoId: number, stats: { liked?: boolean; likeCount?: number; isSaved?: boolean; saveCount?: number; shareCount?: number; reposted?: boolean; repostedBy?: VideoRepostUser[] }) => {
  const queryKeys = [
    ["all-videos"],
    ["infinite-videos"],
    ["user-videos"],
